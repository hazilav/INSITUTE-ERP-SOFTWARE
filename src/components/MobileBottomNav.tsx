...
export default function MobileBottomNav({ role }: MobileBottomNavProps) {
  ...
  if (isStaffOrMentor) {
    ...
    const staffMoreItems = [
      ...
      { name: "My Attendance", href: "/dashboard/staff/my-attendance", icon: CalendarCheck },
      { name: "My Profile", href: "/dashboard/staff", icon: User },
    ];
      ...
      <>
        ...
        <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-slate-200 px-2 py-1.5 flex items-center justify-around shadow-lg">
          ...
          <button
            ...
            className="flex flex-col items-center gap-0.5 py-1 px-3 rounded-xl text-slate-500 hover:text-slate-900"
          >
  ...
  // Owner / Admin Mobile Bottom Navigation
  const ownerTabs = [
    { name: "Home", href: "/dashboard", icon: LayoutDashboard },
    { name: "Students", href: "/dashboard/students", icon: Users },
    { name: "Tasks", href: "/dashboard/reports/staff-tasks", icon: ClipboardList },
